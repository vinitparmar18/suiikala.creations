...
function CategoriesPage() {
  ...
  // --- 🌟 ALAG SE HIS FAVOURITES ADD KAR DIYA ---
  if (!mergedList.some((c) => c.slug === "his-favourites")) {
    mergedList.push({
      id: "static-his-favourites",
      slug: "his-favourites",
      name: "His Favourites",
      description: "Handmade collection",
      image: colHisFavourites,
      sort_order: 5, // Aap list me position manage karne ke liye isko change kar sakte hain
      active: true
    });
  }
